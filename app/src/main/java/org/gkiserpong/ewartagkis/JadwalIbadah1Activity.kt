...
class JadwalIbadah1Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        actionBar!!.title = resources.getString(R.string.title_activity_jadwal_ibadah)
        actionBar.setDisplayHomeAsUpEnabled(true)

        loader.visibility = View.VISIBLE

        val URIAddress = "https://ewarta.gkiserpong.org/wp-content/json/jadwalibadah.json"
        ...
        FileLoader.with(this)
            ...
            .asFile(object: FileRequestListener<File> {
                ...
                override fun onError(p0: FileLoadRequest?, p1: Throwable?) {
                    ...
                    Toast.makeText(this@JadwalIbadah1Activity, "Use local json", Toast.LENGTH_SHORT).show()
                    loader.visibility = View.GONE
                    val jsonStream = applicationContext.assets.open("jadwalibadah.json")
